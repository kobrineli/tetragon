...
{{< warning >}}
Same field cannot be present in a macro definition and in a policy selector
that uses the macro.  More info
[here](/docs/concepts/tracing-policy/hooks/#macros-limitations).
{{< /warning >}}
